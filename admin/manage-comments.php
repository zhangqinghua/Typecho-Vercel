			...
			<div class="typecho-list-operate clearfix">
				<form method="get">
					...
					<div class="search" role="search">
						...
						<?php endif; ?>
						<?php $keywords = $request->keywords; if($keywords !== null){$keywords = htmlspecialchars($keywords);}else{$keywords='';} ?>
						<input type="text" class="text-s" placeholder="<?php _e('请输入关键字'); ?>" value="<?php echo $keywords; ?>"<?php if ('' == $request->keywords): ?> onclick="value='';name='keywords';" <?php else: ?> name="keywords"<?php endif; ?>/>
