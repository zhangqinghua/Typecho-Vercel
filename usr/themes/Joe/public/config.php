...
if (isset($fontUrl) && strpos((string)$fontUrl, 'woff2') !== false) $fontFormat = 'woff2';
elseif (isset($fontUrl) && strpos((string)$fontUrl, 'woff') !== false)  $fontFormat = 'woff';
elseif (isset($fontUrl) && strpos((string)$fontUrl, 'ttf') !==false) $fontFormat = 'truetype';
elseif (isset($fontUrl) && strpos((string)$fontUrl, 'eot') !==false) $fontFormat = 'embedded-opentype';
elseif (isset($fontUrl) && strpos((string)$fontUrl, 'svg') !==false) $fontFormat = 'svg';
?>
<style>
  @font-face {
