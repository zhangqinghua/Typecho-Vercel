...
//        }
     ...
     * @throws Crash
     */
    public function metcip_kat_dynamic_drag($data)
    {
        $this->check_access('editor');
        ...
        $list = Typecho_Plugin::factory('Nabo_Dynamics')
            ->trigger($pluggable)
            ->select(
                $this->liteuser->uid, $status, $size, $page
            );
    ...
    public function metcip_kat_dynamic_push($data)
    {
        ...
        $result = Typecho_Plugin::factory('Nabo_Dynamics')
            ->trigger($pluggable)
    ...
    public function metcip_kat_dynamic_roll($did)
    {
        ...
        $deleteCount = Typecho_Plugin::factory('Nabo_Dynamics')
            ->trigger($pluggable)
            ->delete(
    ...
    public function metcip_kat_friend_drag($data)
    {
        ...
        $list = Typecho_Plugin::factory('Nabo_Friend')
            ->trigger($pluggable)
            ->select(
                $this->liteuser->uid,
    ...
    public function metcip_kat_friend_push($data)
    {
        ...
        $result = Typecho_Plugin::factory('Nabo_Friend')
            ->trigger($pluggable)
            ->{$insert ? 'insert' : 'modify'}(
    ...
    public function metcip_kat_friend_roll($lid)
    {
        ...
        $deleteCount = Typecho_Plugin::factory('Nabo_Friend')
            ->trigger($pluggable)
            ->delete(
